const PartnerCTA = () => {
  return (
    <section
      id="commitment"
      className="group relative border-t border-[#e4e0db] bg-[#162F54] py-16 sm:py-20 md:py-28 lg:py-[140px]"
    >
     
      <div className="layout-7xl relative z-10">
        <div className="max-w-[960px] mx-auto text-center">
          <span className="inline-flex items-center gap-3 font-poppins text-[11px] font-medium tracking-[0.28em] uppercase text-white/80">
            The Commitment
          </span>

          <blockquote className="my-8 sm:my-10 font-[PPFONT] text-[1.7rem] sm:text-[2rem] leading-[1.55] text-white italic font-normal">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 font-poppins text-[14px]">
            <div>
              ...
              <span className="block text-white/70 italic text-[13px] mt-0.5">
